...
Funcionalidade: Formulario de cotacao de seguro
  ...
  Cenario: Visualizar aba Enter Insurant Data ao cadastrar os dados do carro
    ...
    E informar a capacidade "10" no campo Cylinder Capacity
    ...
    E selecionar a opcao "2" no campo Number of Seats MotorCycle
    E selecionar a opcao "Diesel" no campo Fuel Type
    E informar o peso "10" no campo Payload
    E informar o peso total "100" no campo Total Weight
    ...
    E informar a data "10/15/1992" no campo Date of Birth
    ...
    E informar a data "10/30/2021" no campo Start Date
    ...
    E informar o password "Ch123456" no campo Password
    E informar o password "Ch123456" no campo Confirm Password
